...
public class Orador {
	...
	public Orador(String nombre, String apellido,String mail,String tema, String fec_presentacion) {
	...
	public Orador(Long id_orador, String nombre, String apellido,String mail,String tema, String fecha) {
		this.id_orador = id_orador;
		this.nombre = nombre;
		this.apellido = apellido;
		this.mail = mail;
		this.tema = tema;
		this.fec_presentacion = fecha;
	}
	...
	public String toString() {
		return "Orador : nombre=" + nombre + ", apellido=" + apellido + ", mail=" + mail + ", fecha=" + fec_presentacion;
	}
